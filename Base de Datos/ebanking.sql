...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 29, 2024 at 07:55 PM
...
CREATE TABLE `transaccion` (
  ...
  `cuenta_origenn` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `transaccion` (`id_transaccion`, `cuenta_destino`, `fech_transaccion`, `moneda`, `monto`, `motivo`, `cuenta_origenn`) VALUES
(77777, 1234, '2024-03-19', 'Dolar Estadounidense', 2500, 'Pago mensual', 123);
...
ALTER TABLE `transaccion`
  ...
  ADD KEY `usuario_destino` (`cuenta_destino`),
  ADD KEY `cuenta_transaccion` (`cuenta_origenn`);
...
--
ALTER TABLE `transaccion`
  ADD CONSTRAINT `cuenta_transaccion` FOREIGN KEY (`cuenta_origenn`) REFERENCES `cuenta` (`id_cuenta`),
  ADD CONSTRAINT `usuario_destino` FOREIGN KEY (`cuenta_destino`) REFERENCES `cuenta` (`id_cuenta`);
COMMIT;
